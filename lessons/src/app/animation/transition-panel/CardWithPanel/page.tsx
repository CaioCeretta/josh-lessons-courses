...
import { TransitionPanel } from '@/app/animation/_components/transition-panel';
import { type } from 'os';
...
export default function TransitionPanelCard() {
  ...
  return (
    <div className='w-[364px] overflow-hidden my-10 rounded-xl border border-zinc-950/10 bg-white dark:bg-zinc-700'>
      <TransitionPanel
